...
<ul class="side-cart__controls js-side-cart-item-controls">
	...
	<li class="side-cart__control_item">
		...
		<input type="number" step="1" min="0" name="cart[<?php echo esc_attr( $cart_item_key ); ?>][qty]" value="<?php echo esc_attr( $cart_item['quantity'] ); ?>" title="<?php echo esc_attr__( 'Qty', 'woocommerce' ); ?>" aria-label="<?php echo esc_attr__( 'Quantity', 'woocommerce' ); ?>" class="input-text qty js-side-cart-change-qty text side-cart__qty" size="4" data-product_id="<?php echo esc_attr( $product->get_id() ); ?>" data-product_sku="<?php echo esc_attr( $product->get_sku() ); ?>" data-cart_item_key="<?php echo esc_attr( $cart_item_key ); ?>" />
